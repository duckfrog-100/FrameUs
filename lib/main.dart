...
class _CreateFrameScreenState extends State<CreateFrameScreen> {
  ...
  static const List<String> _shootingCycles = ['매일', '매주', '직접 설정'];
  ...
  Future<void> _saveFrame() async {
    ...
    try {
      ...
      _customCycleController.clear();
      setState(() {
        _selectedFrameType = _frameTypes.first;
        _selectedShootingCycle = _shootingCycles[1];
      });
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  '프레임명, 유형, 촬영 주기를 정하면 반복 촬영 기록을 시작할 수 있어요.',
